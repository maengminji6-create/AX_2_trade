"""
타이타닉 데이터셋 기초 탐색
pandas head/tail/shape/info/colums 사용해서 데이터셋의 기본 정보를 화면에 순서대로 보여주는 streamlit 앱이다.
실행방법 streamlit run day3 9-7-1.py
"""
...
st.caption("pandas의 head/tail/shape/info/colums로 데이터 기본 정보를 확인합니다.")


# Titanic.csv가져오기
csv_path = "Titanic.csv"

upload_file = st.file_uploader("Tatinic.csv 파일을 직접 업로드 할 수 있습니다(선택사항)", type="csv")
...
if df is not None:
    ...
    st.subheader("2) tail(): 데이터의 앞부분 5행 미리보기")
